...
public class SinglePointCrossover<T extends BinaryChromosome> implements ICrossOver<T> {
	...
	public T[] CrossOver(T[] parents) throws GeneticAlgorithmException {
		...
		int r2 = (int) (1 + Math.random() * parents[0].getLength());
		...
		offspring1.setEncoding(parent1.substring(0, r2).concat(parent2.substring(r2)));
		offspring2.setEncoding(parent2.substring(0, r2).concat(parent1.substring(r2)));
